...
class TestHBNBCommand_destroy(unittest.TestCase):
    ...
    def test_destroy_objects_space_notation(self):
        ...
        with patch("sys.stdout", new=StringIO()) as output:
            obj = storage.all()["Review.{}".format(testID)]
OBOBOBOBOBOBOBOBOBOBOBOBOBOBOB            command = "show Review {}".format(testID)
OBOBOBOBOBOBOBOBOBOBOBOBOBOBOB            self.assertFalse(HBNBCommand().onecmd(command))
OBOBOBOBOBOBOBOBOBOBOBOBOBOBOB            self.assertNotIn(obj, storage.all())
OBOBOBOBOBOBOBOBOBOBOBOBOBOBOBOBOBOBOB
    def test_destroy_objects_dot_notation(self):
OBOBOBOBOBOBOBOBOBOBOB        with patch("sys.stdout", new=StringIO()) as output:
OBOBOBOBOBOBOBOBOBOBOB            self.assertFalse(HBNBCommand().onecmd("create BaseModel"))
OBOBOBOBOBOBOBOBOBOBOB            testID = output.getvalue().strip()
        with patch("sys.stdout", new=StringIO()) as output:
OBOBOBOB            obj = storage.all()["BaseModel.{}".format(testID)]
            command = "BaseModel.destroy({})".format(testID)
OBOBOBOBOBOB            self.assertFalse(HBNBCommand().onecmd(command))
            self.assertNotIn(obj, storage.all())
        with patch("sys.stdout", new=StringIO()) as output:
            self.assertFalse(HBNBCommand().onecmd("create User"))
OB            testID = output.getvalue().strip()
OBOB        with patch("sys.stdout", new=StringIO()) as output:
OB            obj = storage.all()["User.{}".format(testID)]
OB            command = "User.destroy({})".format(testID)
OB            self.assertFalse(HBNBCommand().onecmd(command))
OB            self.assertNotIn(obj, storage.all())
        with patch("sys.stdout", new=StringIO()) as output:
OB            self.assertFalse(HBNBCommand().onecmd("create State"))
OB            testID = output.getvalue().strip()
OB        with patch("sys.stdout", new=StringIO()) as output:
OB            obj = storage.all()["State.{}".format(testID)]
            command = "State.destroy({})".format(testID)
OB            self.assertFalse(HBNBCommand().onecmd(command))
OB            self.assertNotIn(obj, storage.all())
OB        with patch("sys.stdout", new=StringIO()) as output:
OB            self.assertFalse(HBNBCommand().onecmd("create Place"))
            testID = output.getvalue().strip()
OB        with patch("sys.stdout", new=StringIO()) as output:
            obj = storage.all()["Place.{}".format(testID)]
OB            command = "Place.destroy({})".format(testID)
OB            self.assertFalse(HBNBCommand().onecmd(command))
            self.assertNotIn(obj, storage.all())
OB        with patch("sys.stdout", new=StringIO()) as output:
            self.assertFalse(HBNBCommand().onecmd("create City"))
...
OB        with patch("sys.stdout", new=StringIO()) as output:
        ...
        with patch("sys.stdout", new=StringIO()) as output:
            ...
            testID = output.getvalue().strip()
        with patch("sys.stdout", new=StringIO()) as output:
OB            obj = storage.all()["Amenity.{}".format(testID)]
OBOBOBOBOBOBOBOBOBOBOBOBOBOBOB            command = "Amenity.destroy({})".format(testID)
            self.assertFalse(HBNBCommand().onecmd(command))
OBOBOBOBOBOBOBOBOBOBOBOBOBOBOBOBOBOBOB            self.assertNotIn(obj, storage.all())
OBOBOBOBOBOB        with patch("sys.stdout", new=StringIO()) as output:
            self.assertFalse(HBNBCommand().onecmd("create Review"))
            testID = output.getvalue().strip()
OBOB        with patch("sys.stdout", new=StringIO()) as output:
OBOBOB            obj = storage.all()["Review.{}".format(testID)]
            command = "Review.destory({})".format(testID)
OBOB            self.assertFalse(HBNBCommand().onecmd(command))
OB            self.assertNotIn(obj, storage.all())
OBOB
OB
OBOBclass TestHBNBCommand_all(unittest.TestCase):
OB    """Unittests for testing all of the HBNB command interpreter."""
OB
OB    @classmethod
OB    def setUp(self):
OB        try:
...
OB    def test_all_invalid_class(self):
        correct = "** class doesn't exist **"
OB        with patch("sys.stdout", new=StringIO()) as output:
            self.assertFalse(HBNBCommand().onecmd("all MyModel"))
OB            self.assertEqual(correct, output.getvalue().strip())
        with patch("sys.stdout", new=StringIO()) as output:
OB            self.assertFalse(HBNBCommand().onecmd("MyModel.all()"))
            self.assertEqual(correct, output.getvalue().strip())
OB
...
OB            self.assertFalse(HBNBCommand().onecmd("create State"))
            self.assertFalse(HBNBCommand().onecmd("create Place"))
OB            self.assertFalse(HBNBCommand().onecmd("create City"))
            self.assertFalse(HBNBCommand().onecmd("create Amenity"))
            self.assertFalse(HBNBCommand().onecmd("create Review"))
OB        with patch("sys.stdout", new=StringIO()) as output:
            self.assertFalse(HBNBCommand().onecmd("all"))
            self.assertIn("BaseModel", output.getvalue().strip())
OB            self.assertIn("User", output.getvalue().strip())
            self.assertIn("State", output.getvalue().strip())
            self.assertIn("Place", output.getvalue().strip())
            self.assertIn("City", output.getvalue().strip())
            self.assertIn("Amenity", output.getvalue().strip())
OB            self.assertIn("Review", output.getvalue().strip())

    def test_all_objects_dot_notation(self):
        with patch("sys.stdout", new=StringIO()) as output:
            self.assertFalse(HBNBCommand().onecmd("create BaseModel"))
OB            self.assertFalse(HBNBCommand().onecmd("create User"))
            self.assertFalse(HBNBCommand().onecmd("create State"))
            self.assertFalse(HBNBCommand().onecmd("create Place"))
            self.assertFalse(HBNBCommand().onecmd("create City"))
            self.assertFalse(HBNBCommand().onecmd("create Amenity"))
            self.assertFalse(HBNBCommand().onecmd("create Review"))
        with patch("sys.stdout", new=StringIO()) as output:
OB            self.assertFalse(HBNBCommand().onecmd(".all()"))
            self.assertIn("BaseModel", output.getvalue().strip())
